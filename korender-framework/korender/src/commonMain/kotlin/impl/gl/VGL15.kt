...
object VGL15 {
    ...
    var gl: com.zakgof.korender.impl.gl.IGL15? = null
    ...
    fun glBindBuffer(target: Int, buffer: Int) {
        com.zakgof.korender.impl.gl.VGL15.gl!!.glBindBuffer(target, buffer)
    }
    ...
    fun glBufferData(target: Int, data: ByteBuffer, usage: Int) {
        com.zakgof.korender.impl.gl.VGL15.gl!!.glBufferData(target, data, usage)
    }
     ...
     */
    fun glGenBuffers(): Int = com.zakgof.korender.impl.gl.VGL15.gl!!.glGenBuffers()


    fun glDeleteBuffers(buffer: Int) = com.zakgof.korender.impl.gl.VGL15.gl!!.glDeleteBuffers(buffer)
