...
internal class NewInstancedMesh(
    val prototype: NewMesh,
    val instances: Int
) : NewMesh(prototype.vertexCount * instances, prototype.indexCount * instances, prototype.attributes) {
