...
internal object MeshAttributes {
    ...
    val INSTCOLORTEXINDEX = InternalMeshAttribute<Byte>("colortexindex", 1, AttributeType.SignedByte, 8, ByteBufferAccessor, true)
    ...
    val INSTSCREEN = InternalMeshAttribute<FloatArray>("instscreenrect", 4, AttributeType.Float, 12, Float4BufferAccessor, true)
}