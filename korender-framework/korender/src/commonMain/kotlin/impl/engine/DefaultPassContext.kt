...
internal class DefaultPassContext(
    ...
    override fun Billboard(vararg materialModifiers: MaterialModifier, position: Vec3, transparent: Boolean) {
        ...
        passDeclaration.add(RenderableDeclaration(MeshDeclaration.Billboard, materialDeclaration.shader, materialDeclaration.uniforms, Transform().translate(position), if (transparent) Bucket.TRANSPARENT else Bucket.OPAQUE))
    }
    ...
    override fun Screen(vararg materialModifiers: MaterialModifier) {
        ...
        passDeclaration.add(RenderableDeclaration(MeshDeclaration.ScreenQuad, materialDeclaration.shader, materialDeclaration.uniforms, Transform(), Bucket.SCREEN))
    }
    ...
    override fun Sky(vararg materialModifiers: MaterialModifier) {
        ...
        passDeclaration.add(RenderableDeclaration(MeshDeclaration.ScreenQuad, materialDeclaration.shader, materialDeclaration.uniforms, Transform(), Bucket.SKY))
    }
    ...
    override fun InstancedRenderables(
        ...
        passDeclaration.add(
            RenderableDeclaration(
                MeshDeclaration.InstancedMesh(id, count, mesh, materialDeclaration, static, block),
