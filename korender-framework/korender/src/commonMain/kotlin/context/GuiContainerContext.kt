...
interface GuiContainerContext : FrameContext {
    ...
    fun Text(id: Any, text: String, style: TextStyle? = null, fontResource: String? = null, height: Int? = null, color: ColorRGBA? = null, static: Boolean = false, onTouch: TouchHandler = {})
    fun Filler()
