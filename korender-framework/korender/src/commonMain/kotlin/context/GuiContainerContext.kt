...
interface GuiContainerContext : FrameContext {
    ...
    fun Text(id: Any, text: String, textStyle: TextStyle? = null, fontResource: String? = null, height: Int? = null, color: ColorRGBA? = null, static: Boolean = false, onTouch: TouchHandler = {})
    fun Filler()
