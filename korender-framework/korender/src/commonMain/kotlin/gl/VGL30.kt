...
object VGL30 {
    ...
    /** Renamed tokens.  */
    val GL_COMPARE_REF_TO_TEXTURE: Int = VGL14.GL_COMPARE_R_TO_TEXTURE
    val GL_CLIP_DISTANCE0: Int = VGL11.GL_CLIP_PLANE0
    val GL_CLIP_DISTANCE1: Int = VGL11.GL_CLIP_PLANE1
    val GL_CLIP_DISTANCE2: Int = VGL11.GL_CLIP_PLANE2
    val GL_CLIP_DISTANCE3: Int = VGL11.GL_CLIP_PLANE3
    val GL_CLIP_DISTANCE4: Int = VGL11.GL_CLIP_PLANE4
    val GL_CLIP_DISTANCE5: Int = VGL11.GL_CLIP_PLANE5
    const val GL_CLIP_DISTANCE6: Int = 0x3006
    const val GL_CLIP_DISTANCE7: Int = 0x3007
    val GL_MAX_CLIP_DISTANCES: Int = VGL11.GL_MAX_CLIP_PLANES
    val GL_MAX_VARYING_COMPONENTS: Int = VGL20.GL_MAX_VARYING_FLOATS
