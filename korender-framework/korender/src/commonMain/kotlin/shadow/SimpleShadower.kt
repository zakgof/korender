...
import com.zakgof.korender.engine.Inventory
import com.zakgof.korender.engine.Renderable
...
internal class SimpleShadower(private val inventory: Inventory, shadowDeclaration: ShadowDeclaration, private val shadowCasters: List<Renderable>) {
    ...
    private val frameBuffer: GpuFrameBuffer = inventory.frameBuffer(FrameBufferDeclaration("shadow", shadowDeclaration.mapSize, shadowDeclaration.mapSize, false))
