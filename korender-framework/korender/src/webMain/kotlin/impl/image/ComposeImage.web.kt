...
@OptIn(ExperimentalEncodingApi::class, ExperimentalUnsignedTypes::class, ExperimentalWasmJsInterop::class, ExperimentalResourceApi::class)
internal actual fun composeImageFromArgbPixels(width: Int, height: Int, argbPixels: IntArray): ImageBitmap {
    ...
    val clampedBytes = Uint8ClampedArray(rgbaBytes.buffer, rgbaBytes.byteOffset, rgbaBytes.length)
    imageData.data.set(clampedBytes)
    ...
    return pngBytes.decodeToImageBitmap()
}
