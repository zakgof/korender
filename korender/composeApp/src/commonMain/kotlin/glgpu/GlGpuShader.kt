...
class GlGpuShader(
    ...
    private fun fetchUniforms(): Map<String, Int> {
        ...
        return (0 until numUniforms).map {
            val name: String = VGL20.glGetActiveUniform(programHandle, it, params.clear() as IntBuffer, type.clear() as IntBuffer)
    ...
    private fun fetchAttributes(): Map<String, Int> {
        ...
        return (0 until numAttributes).map {
            val name: String = VGL20.glGetActiveAttrib(programHandle, it, params.clear() as IntBuffer, type.clear() as IntBuffer)
    ...
    private fun bind(value: Any, location: Int, currentTexUnit: Int) : Boolean {
        ...
        when (value) {
            ...
            is Mat4 -> VGL20.glUniformMatrix4fv(location, false, value.asBuffer().rewind() as FloatBuffer)
            is Mat3 -> VGL20.glUniformMatrix3fv(location, false, value.asBuffer().rewind() as FloatBuffer)
            is GpuTexture -> {
